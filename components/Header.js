...
function Header({placeholder}) {
  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 p-5 bg-white shadow-md md:px-10">
      {/* left */}
      <div onClick={()=> router.push("/")} className="relative flex items-center h-10 cursor-pointer md:shadow-sm">
        <Image
      ...
      <div className="flex items-center py-2 rounded-full md:border-2">
        <input
          ...
          className="flex-grow pl-2 text-sm text-gray-600 placeholder-gray-400 bg-transparent outline-none"
          type="text"
